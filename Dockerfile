FROM ubuntu:groovy
LABEL maintainer "irfanfebrian13 <irfanifebrians13@gmail.com>"
...
RUN pip3 install -r https://raw.githubusercontent.com/irfanfebrian13/ProjectIFS/master/requirements.txt
